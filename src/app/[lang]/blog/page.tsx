...
export async function generateMetadata({
  ...
  const pageUrl = `${url}/${language}/blog`;

  const translations = {
    en: {
      title: "Blog",
      description: "Articles, thoughts, and insights about web development, technology, and digital solutions.",
    },
    pt: {
      title: "Blog",
      description: "Artigos, pensamentos e insights sobre desenvolvimento web, tecnologia e soluções digitais.",
    },
  };
